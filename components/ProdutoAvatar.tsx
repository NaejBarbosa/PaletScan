...
export default function ProdutoAvatar({ ean, descricao }: ProdutoAvatarProps) {
  ...
  return (
    <div className="w-full h-64 relative flex items-center justify-center overflow-hidden bg-white rounded-xl shrink-0 border border-slate-200 dark:border-slate-800">
      {hasError ? (
